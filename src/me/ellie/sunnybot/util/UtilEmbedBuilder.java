 ...
 */
public class UtilEmbedBuilder extends EmbedBuilder {
     ...
     */
         ...
         */
        public UtilEmbedBuilder removeField(String title) {
            pullUpdate();
         ...
         * @return The UtilsEmbedBuilder instance.
         */
        public UtilEmbedBuilder setFieldValue(String title, String value) {
         ...
         * @return The UtilsEmbedBuilder instance.
         */
        public UtilEmbedBuilder replaceFieldValue(String title, String from, String to) {
            pullUpdate();
            fields.stream().filter(fStream -> fStream.getName().equalsIgnoreCase(title))
                    .forEach(fStream -> {
                        try {
         ...
         * @return The UtilsEmbedBuilder instance
         */
        public UtilEmbedBuilder setFieldInline(String title, boolean inline) {
            pullUpdate();
            fields.stream().filter(fStream -> fStream.getName().equalsIgnoreCase(title))
                    .forEach(fStream -> {
                        try {
